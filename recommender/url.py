...
urlpatterns = [
    ...
    path('admin_forgot_username/',admin_forgot_username_view,name='admin_forgot_username'),
    path('admin_forgot_password/',admin_forgot_password_view,name='admin_forgot_password'),
